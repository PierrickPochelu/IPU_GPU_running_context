...
def get_glue_data(task, micro_batch_size, cache_dir,num_epochs=1, max_seq_length=None, generated_dataset=False):
    task_to_keys = {
        "cola": ("sentence", None),
    ...
    train_dataset = train_dataset.repeat(num_epochs+1)
